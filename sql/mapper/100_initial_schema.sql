...
-- Wed 14 Sep 2016 11:28:07 AM EDT
...
CREATE TABLE IF NOT EXISTS `samples` (
  ...
  `reads` BIGINT NULL DEFAULT NULL,
  `created_at` DATETIME NOT NULL,
  `modified_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE INDEX `fk_results_2_idx` ON `results` (`state_id` ASC);

CREATE INDEX `fk_results_3_idx` ON `results` (`step_id` ASC);
